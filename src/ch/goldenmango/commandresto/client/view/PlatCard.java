...
public class PlatCard extends Composite {

	private static PlatCardUiBinder uiBinder = GWT.create(PlatCardUiBinder.class);
	private static NumberFormat currFmt =  NumberFormat.getCurrencyFormat();

	interface PlatCardUiBinder extends UiBinder<Widget, PlatCard> {
	}
	private Plat plat;
	
//	@UiField
//	MaterialCardTitle titre;
	...
	public PlatCard(Plat plat,String noByType) {
		this.plat = plat;
		initWidget(uiBinder.createAndBindUi(this));
//		titre.setText(plat.getTitre());
		desc.setText(noByType + " " + plat.getDescr());
